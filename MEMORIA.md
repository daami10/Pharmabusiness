...
| **8** | `2026-06-15` | **Corrección de Bugs en Frontend (React)**: Solucionado el desfase de alineación a la derecha en los botones rápidos de "Registrar Seguro Social" y "Añadir Impuesto / Tasa" en el dashboard. Corregido el Calendario de Vencimientos para que remueva el contorno de selección del día actual cuando el usuario selecciona cualquier otro día, evitando bordes duplicados. | Completado |
