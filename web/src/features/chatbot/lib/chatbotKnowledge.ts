...
export const KNOWLEDGE_BASE: KnowledgeArticle[] = [
  ...
  {
    id: 'equipos_permisos',
    title: 'Gestión de Equipos, Invitaciones y Permisos',
    keywords: [
      'equipo',
      'equipos',
      'invitar',
    ...
    content:
      'En **Configuración de la Farmacia** → **Equip y Permisos** puedes gestionar quién accede a la aplicación:\n\n* **Invitar a un trabajador**: Pulsa en **"Convidar treballador"** (Invitar trabajador), rellena el nombre, correo electrónico y define sus permisos específicos.\n* **Límite de asientos**: Las cuentas tienen un límite máximo de **3 asientos** para usuarios de tu farmacia.\n* **Enlace de invitación (Token)**: El sistema no envía correos automáticos. Para registrar al empleado, haz clic en **"Copiar enlace de invitación"** al lado de la invitación pendiente y envíaselo por WhatsApp, email o Slack. El enlace contiene un token de registro seguro.\n* **Permisos Granulares**: Puedes limitar el acceso de cada empleado para que solo pueda realizar ciertas acciones (ej. "Ver Facturas", "Subir/Editar Facturas", "Ver Abonos", "Gestionar Abonos", "Ver Análisis y Gráficos", "Ver Fiscalidad" o "Ver Trabajadores y Nóminas"). El rol de propietario (Titular) tiene control total y es el único que gestiona invitaciones.',
    suggestions: [
      '¿Cómo copio el enlace para invitar a un empleado?',
      '¿Qué permisos le puedo dar a un trabajador?',
    ],
  },
  {
    id: 'suscripcion_stripe',
    title: 'Planes de Suscripción y Portal de Clientes (Stripe)',
    keywords: [
      'suscripcion',
      'suscripción',
      'suscripciones',
    ...
    content:
      'GFarma ofrece diferentes planes y se integra de forma segura con Stripe para el cobro de suscripciones:\n\n* **Planes Disponibles**: Existen planes de tipo **Básico** y **Premium** adaptados a las necesidades de tu farmacia.\n* **Muro de pago (Subscription Gate)**: Si el período de prueba gratuita caduca, la aplicación restringirá el acceso y las operaciones de escritura/lectura en la base de datos hasta que se active una suscripción activa.\n* **Portal de Clientes de Stripe**: Puedes gestionar tu suscripción en cualquier momento accediendo a **Configuración** → pestaña **Facturación** → **Portal de clientes**. Allí podrás:\n  1. Cambiar o actualizar tu tarjeta de crédito o débito.\n  2. Consultar y descargar el histórico de facturas PDF de tus suscripciones mensuales.\n  3. Cancelar tu plan o cambiar entre niveles de suscripción de forma segura.',
    suggestions: [
      '¿Cómo cambio mi tarjeta de pago?',
      '¿Dónde descargo las facturas de mi suscripción de GFarma?',
    ],
  },
]
