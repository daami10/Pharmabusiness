...
import { BarChart3, Check, LogOut, Lock, Sparkles } from 'lucide-react'
...
export function SubscriptionGate({ children }: { children: ReactNode }) {
  ...
  const isOwner = userRole === 'titular'
        ...
        <div className="w-full max-w-3xl">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              {isOwner
                ? 'Tu periodo de prueba ha finalizado. Suscríbete para seguir gestionando tu farmacia.'
                : 'El periodo de prueba de tu farmacia ha finalizado. Solicita al Titular que reactive el acceso.'}
            </p>
          </div>
